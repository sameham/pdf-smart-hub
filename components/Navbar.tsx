          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {user ? (
              <>
                ...
                <button onClick={handleSignOut} className="flex items-center gap-1 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-red-600 transition">
              ...
              <>
                <Link href="/login" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 transition">
                  دخول
                </Link>
        ...
        <div className="md:hidden border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 px-4 py-4 space-y-1">
          ...
          {user ? (
            <>
              ...
              <button onClick={() => { handleSignOut(); setMobileOpen(false) }} className="block w-full text-right px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 rounded-xl">
                خروج
              </button>
            </>
          ) : (
