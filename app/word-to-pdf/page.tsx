...
import { FileText, Upload, Download, CheckCircle, AlertCircle, FileUp } from "lucide-react";
...
export default function WordToPdfPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      // Use LibreOffice-style conversion via API
      ...
      toast.error("حدث خطأ أثناء التحويل. يرجى المحاولة مرة أخرى.");
    } finally {
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 text-lg">
            حوّل ملفات Word (doc, docx) إلى PDF بجودة عالية وبسهولة تامة
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mt-10">
          {[
            { icon: "🔒", title: "آمن 100%", desc: "ملفاتك لا تُرفع لأي سيرفر خارجي" },
            { icon: "⚡", title: "سريع", desc: "تحويل فوري بدون انتظار" },
